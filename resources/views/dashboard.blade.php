...
<div class="row">
    <div class="col-md-6 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6>أحدث المنتجات</h6>
                <a href="{{ route('products.index') }}" class="btn btn-sm btn-primary">عرض الكل</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">{{ $product->category->name ?? 'غير مصنف' }}</small>
                            </div>
                            <div class="text-end">
                                <span class="badge bg-primary">{{ number_format($product->price, 2) }} ر.س</span>
                                <br>
                ...
                @else
                    <p class="text-muted text-center">لا توجد منتجات حالياً</p>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6>منتجات قاربت على النفاد</h6>
                <a href="{{ route('products.index') }}?status=low_stock" class="btn btn-sm btn-warning">عرض الكل</a>
            </div>
            <div class="card-body">
                @if($lowStockItems->count() > 0)
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                <span class="badge bg-warning">{{ $product->quantity }} وحدة</span>
                                <br>
                                <small class="text-muted">كمية محدودة</small>
                            </div>
                        </div>
                        @endforeach
                    </div>
                @else
                    <p class="text-success text-center">لا توجد منتجات قاربت على النفاد</p>
                @endif
            </div>
        </div>
    </div>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-3">
                        <div class="border rounded p-3">
                            ...
                            <p class="text-muted">إجمالي الفئات</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border rounded p-3">
                            ...
                            <p class="text-muted">منتجات كمية محدودة</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border rounded p-3">
                            ...
                            <p class="text-muted">منتجات غير متوفرة</p>
                        </div>
                    </div>
                </div>
                
                <div class="mt-4 text-center">
                    <a href="{{ route('products.index') }}" class="btn btn-primary me-2">إدارة المنتجات</a>
                    <a href="{{ route('categories.index') }}" class="btn btn-success me-2">إدارة الفئات</a>
                    <a href="{{ route('products.create') }}" class="btn btn-info">إضافة منتج جديد</a>
                </div>
            </div>
        </div>
    </div>
